...
namespace VRTK
{
    ...
    public class VRTK_InteractableObject : MonoBehaviour
    {
        ...
        void Start()
        {
            pointer = pointerObject.GetComponent<VRTK_Pointer>();
        }
...
#pragma warning restore 0618
        ...
        {
            //conditional for custom transform of objects for flaot
            if (tag == "person") {
                ...
                {
                    throw new System.Exception("Please point at floor");
                }
            }
            else if (tag == "projector")
            {
                ...
                {
                    throw new System.Exception("Please point at ceiling");
                }

            }
            else if (tag != "person"&&tag!="projector") {
                UnpauseCollisions();
                RemoveTrackPoint();
                ResetUseState(previousGrabbingObject);
                grabbingObjects.Clear();
